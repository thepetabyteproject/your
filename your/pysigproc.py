...
class SigprocFile(object):
    ...
    def write_header(self, filename):
        ...
        :param self: object from pysigproc
        :param filename: file
    ...
    def append_spectra(spectra, filename):
        """
        Append sepctra to the end of the file
        :param spectra: numpy array of the data to be dumped into the filterbank file
        :param filename: name of the filterbank file
        :return:
        """
        # Move to end of file
