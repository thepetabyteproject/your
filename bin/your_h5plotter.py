...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent(
            """\
            This script can be used to plot the candidate HDF5 format files generated by your_candmaker.py 
            and the ones generated by the Candidate class and save them as a png file. 
            """
        )
