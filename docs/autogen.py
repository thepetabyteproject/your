...
pages = {
    ...
    'io/psrdada.md': ['your.io.dada.DadaManager',
                      'your.io.dada.DadaManager.setup',
                      'your.io.dada.DadaManager.dump_header',
                      'your.io.dada.DadaManager.dump_data',
                      'your.io.dada.DadaManager.mark_filled',
                      'your.io.dada.DadaManager.eod',
                      'your.io.dada.DadaManager.teardown',
                      'your.io.dada.YourDada',
                      'your.io.dada.YourDada.setup',
                      'your.io.dada.YourDada.teardown',
                      'your.io.dada.YourDada.your_dada_header',
                      'your.io.dada.YourDada.to_dada'],

    'io/pysigproc.md': ['your.io.pysigproc.SigprocFile',
                        'your.io.pysigproc.SigprocFile.get_data',
                        'your.io.pysigproc.SigprocFile.unpack',
                        'your.io.pysigproc.SigprocFile.write_header',
                        'your.io.pysigproc.SigprocFile.append_spectra'],

    'io/psrfits.md': ['your.io.psrfits.PsrfitsFile',
                      'your.io.psrfits.PsrfitsFile.read_subint',
                      'your.io.psrfits.PsrfitsFile.get_data',
                      'your.io.psrfits.SpectraInfo',
                      'your.io.psrfits.unpack_2bit',
                      'your.io.psrfits.unpack_4bit'],

    'io/writer.md': ['your.io.writer.Writer.to_fil',
                     'your.io.writer.Writer.to_fits'],

    'io/filwriter.md': ["your.io.filwriter.make_sigproc_obj",
                        "your.io.filwriter.write_fil"],

    'io/fitswriter.md': ["your.io.fitswriter.initialize_psrfits",
                         "your.io.fitswriter.ObsInfo"],
